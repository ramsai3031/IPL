...
teams = pkl.load(open(r'C:\Users\ram sai\OneDrive\Desktop\Ipl\team.pkl','rb'))
cities = pkl.load(open(r'C:\Users\ram sai\OneDrive\Desktop\Ipl\city.pkl','rb'))
model = pkl.load(open(r'C:\Users\ram sai\OneDrive\Desktop\Ipl\model.pkl','rb'))
